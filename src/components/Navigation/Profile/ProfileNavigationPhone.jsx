    ...
    <div className={wrapperClass}>
      <div className={`${styles["nav--section"]}`}>
        <nav className={styles.navbar}>
          <button className={styles.hide} onClick={expandNav}>
            <p className={styles["hide-content"]}>{nameNav}</p>
          </button>
            ...
            <div className={menuNacClass}>
              ...
              <li onClick={() => navigate("")}>
                <NavLink
                  ...
                  to=""
                  onClick={() => {
                    changeNavLabel("USER INFO");
                    expandNav();
                  }}
                  className={({ isActive }) =>
                    !isActive
                      ? styles["navbar--menu-item"]
                      : `${styles["navbar--menu-item-active"]} ${styles["navbar--menu-item-active1"]}`
                  }
                >
                  USER INFO
                </NavLink>
              ...
              <li onClick={() => navigate("tokens")}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    !isActive
                      ? styles["navbar--menu-item"]
                      : `${styles["navbar--menu-item-active"]} ${styles["navbar--menu-item-active2"]}`
                  }
                >
                  TOKENS
                </NavLink>
              ...
              <li onClick={() => navigate("locker")}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    !isActive
                      ? styles["navbar--menu-item"]
                      : `${styles["navbar--menu-item-active"]} ${styles["navbar--menu-item-active3"]}`
                  }
                >
                  LOCKER
                </NavLink>
              ...
              <li onClick={() => navigate("settings")}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    !isActive
                      ? styles["navbar--menu-item"]
                      : `${styles["navbar--menu-item-active"]} ${styles["navbar--menu-item-active4"]}`
                  }
                >
                  SETTINGS
                </NavLink>
              ...
              <li onClick={() => navigate("help")}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    !isActive
                      ? styles["navbar--menu-item"]
                      : `${styles["navbar--menu-item-active"]} ${styles["navbar--menu-item-active5"]}`
                  }
                >
                  HELP
                </NavLink>
