      ...
      <Form method="post" className={styles["login-form--form"]}>
        <div className={styles["login-form-input--container"]}>
          <input
            ...
            className={`${styles["login-form--form-input"]} ${
              emailHasError && styles["login-form--input_invalid"]
            }`}
          ...
          <input
            ...
            className={`${styles["login-form--form-input"]} ${
              passwordHasError && styles["login-form--input_invalid"]
            }`}
        ...
        <div className={styles["login-form--actions"]}>
          <button
            ...
            className={styles["login-form--actions_button"]}
          >
            LOG IN
          </button>
          <Link
            to="/"
            className={`${styles["login-form--actions_button"]} ${styles["login-form--actions_button-register"]}`}
          >
            REGISTER
          </Link>
        </div>
